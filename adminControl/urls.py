...
from .views import update_deposit,fetch_custom_orders,change_action,reset_order_numbers,update_customer_order,delete_unused_products,grant_batches_to_customer,remove_granted_batch,grant_batch_to_customer,delete_batch_order,fetch_orders,finalize_batch,add_orders,orders_panel,update_wallet,update_telegram,approve_withdraw,verify_kyc
urlpatterns = [
